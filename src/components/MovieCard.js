...
export default function MovieCard(props) {
    ...
    useEffect(() => {
        fetch(
            `https://api.themoviedb.org/3/${props.type}/${props.data.id.toString()}?language=en-US`,
            options
        )
    ...
    return (
        <div className="mr-3 w-56 h-fit bg-inherit inline-block snap-start hover:scale-[1.06] ease-in-out duration-150">
